			...
			foreach(scandir("$path$value") as $value_2) {
				if (strpos($value_2, ".") !== 0) {
					...
					if (isset($keywords_2["2"])) {
						...
						$content .= "<a class=\"\" href=\"components/faq/{$get['faq']}/$value/$value_2\">$itemmenu_2</a><p>$description_2</p>";
					} else {
						$content .= "<a class=\"\" href=\"components/faq/{$get['faq']}/$value/$value_2\">$itemmenu_2</a></br>";
					}
				}
			}
		}
