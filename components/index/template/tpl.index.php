    ...
    <div class="row">
      ...
      <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-5 col-sm-6 col-12">
        <div class="card overflow-hidden mb-3">
          <div class="bg-secondary-lighter">
            <div class="row">
              <div class="col-7">
                <div class="p-3">
                  <h5 class="text-secondary">С возвращением!</h5>
                </div>
              </div>
          ...
          <div class="card-body pt-0">
            <div class="row">
              <div class="col-sm-4">
                <div class="avatar-sm profile-user-wid mb-3">
                  <img src="assets/img/avatars/default.svg" alt="Супер А.И." class="img-thumbnail rounded-circle">
                </div>
                <h5 class="font-size-15 text-truncate">Супер А.И.</h5>
                <p class="text-muted mb-0 text-truncate">Администратор ИСП</p></div>
              <div class="col-sm-8">
                <div class="pt-4">
                  <div class="row">
                    <div class="col-6"><h5 class="font-size-15">125</h5>
                      <p class="text-muted mb-0">Событий</p></div>
                    <div class="col-6"><h5 class="font-size-15">12</h5>
                      <p class="text-muted mb-0">Задач</p></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card position-relative bg-primary widget-bdays <?php visuallyHidden($birthday); ?>">
          <div class="card-body">
            <img src="../../../assets/img/decore-left.png" class="congratulations-img-left" alt="card-img-left">
            <img src="../../../assets/img/decore-right.png" class="congratulations-img-right" alt="card-img-right">
            <div>
              <h5 class="text-white text-center">Дни рождения сегодня</h5>
...
<path style="fill:#E1E1E3;" d="M255.99,90.042c-4.807,0-8.705-3.897-8.705-8.705V46.624c0-4.807,3.897-8.705,8.705-8.705
	...
	C473.934,333.207,459.321,318.594,441.295,318.594z"/>
                    ...
                    <div class="bday-group d-flex flex-column ms-3">
                      <p class="today-birthdays-username m-0 fw-bold"><?= $UserAttributes->getShortFIO($row->fullname) ?></p>
