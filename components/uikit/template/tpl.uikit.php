  ...
  <div class="ps-3 pe-3">
    <header class="main-content-header d-flex align-items-center justify-content-between flex-wrap">
      <div class="header-left d-flex align-items-center justify-content-between p-2">
        ...
        <p class="h5 main-content-title mb-0">UI Kit</p>
      </div>
    ...
    <div class="ps-3 pe-3">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Цвета темы</p>
          <p class="mb-3">
            Набор классов для сплошного фона. Используйте класс <code>.bg-*</code> для элемента чтобы задать ему сплошной
            цвет.
          </p>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Светлые цвета темы</p>
          <p class="mb-3">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Осветленные цвета темы</p>
          <p class="mb-3">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Темные цвета темы</p>
          <p class="mb-3">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Затемненныеемные цвета темы</p>
          <p class="mb-3">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Градиенты темы</p>
          <p class="mb-3">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Тени</p>
          <p class="mb-3">
            Используйте класс <code>.grey-shadow-*</code> или <code>.white-shadow-*</code> для элемента, чтобы
            задать
            ему падающую тень.
          </p>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Стиль кнопок по-умолчанию</p>
          <p class="mb-3">
            Используйте класс <code>btn-*</code> после класса <code>btn</code> чтобы создать кнопки по-умолчанию для
            элементов <code>&lt;a&gt;</code>, <code>&lt;button&gt;</code>, или <code>&lt;input&gt;</code>.
          </p>
          ...
          <button type="button" class="btn btn-success mb-2 me-2 text-white">Success</button>
          <button type="button" class="btn btn-info mb-2 me-2 text-white">Info</button>
          <button type="button" class="btn btn-warning mb-2 me-2 text-white">Warning</button>
          <button type="button" class="btn btn-danger mb-2 me-2 text-white">Danger</button>
          <button type="button" class="btn btn-pink mb-2 me-2 text-white">Pink</button>
          <button type="button" class="btn btn-blue mb-2 me-2">Blue</button>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Теги кнопок</p>
          <p class="mb-3">
            Классы <code>btn</code> созданы, чтобы использоваться с элементом <code>&lt;button&gt;</code>.
          </p>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Кнопки с обводкой</p>
          <p class="mb-3">
            Добавьте класс <code>btn-outline-*</code> чтобы создать кнопки с обводкой без заливки.
          </p>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Кнопки со скругленными углами</p>
          <p class="mb-3">
            Добавьте класс <code>btn-rounded</code> чтобы создать кнопки с скругленными углами.
          </p>
          <button type="button" class="btn btn-rounded btn-secondary mb-2 me-2">Secondary</button>
          <button type="button" class="btn btn-rounded btn-primary mb-2 me-2">Primary</button>
          <button type="button" class="btn btn-rounded btn-success mb-2 me-2 text-white">Success</button>
          <button type="button" class="btn btn-rounded btn-info mb-2 me-2 text-white">Info</button>
          <button type="button" class="btn btn-rounded btn-warning mb-2 me-2 text-white">Warning</button>
          <button type="button" class="btn btn-rounded btn-danger mb-2 me-2">Danger</button>
          <button type="button" class="btn btn-rounded btn-pink mb-2 me-2 text-white">Pink</button>
          <button type="button" class="btn btn-rounded btn-dark mb-2 me-2">Dark</button>
          <button type="button" class="btn btn-rounded btn-light mb-2 me-2">Light</button>
        </div>
      </div>
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Кнопки со скругленными углами с обводкой</p>
          <p class="mb-3">
            Добавьте классы <code>btn-rounded btn-outline-*</code> чтобы создать кнопки с скругленными углами и обводкой.
          </p>
          <button type="button" class="btn btn-rounded btn-outline-secondary mb-2 me-2">Secondary</button>
          <button type="button" class="btn btn-rounded btn-outline-primary mb-2 me-2">Primary</button>
          <button type="button" class="btn btn-rounded btn-outline-success mb-2 me-2">Success</button>
          <button type="button" class="btn btn-rounded btn-outline-info mb-2 me-2">Info</button>
          <button type="button" class="btn btn-rounded btn-outline-warning mb-2 me-2">Warning</button>
          <button type="button" class="btn btn-rounded btn-outline-danger mb-2 me-2">Danger</button>
          <button type="button" class="btn btn-rounded btn-outline-pink mb-2 me-2">Pink</button>
          <button type="button" class="btn btn-rounded btn-outline-dark mb-2 me-2">Dark</button>
          <button type="button" class="btn btn-rounded btn-outline-light mb-2 me-2">Light</button>
        </div>
      </div>
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Кнопки разных размеров</p>
          <p class="mb-3">
            Добавьте <code>.btn-lg</code>, <code>.btn-md</code> или <code>.btn-sm</code> для дополнительных размеров.
          </p>
          <button type="button" class="btn btn-secondary btn-lg mb-2 me-2">Large</button>
          <button type="button" class="btn btn-primary btn-md mb-2 me-2">Medium</button>
          <button type="button" class="btn btn-success btn-sm mb-2 me-2 text-white">Small</button>
        </div>
      </div>
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Кнопки разных размеров скругленные</p>
          <p class="mb-3">
            Добавьте <code>btn-lg btn-rounded</code>, <code>btn-md btn-rounded</code> или <code>btn-sm btn-rounded</code> для дополнительных размеров.
          </p>
          <button type="button" class="btn btn-secondary btn-rounded btn-lg mb-2 me-2">Large</button>
          <button type="button" class="btn btn-primary btn-rounded btn-md mb-2 me-2">Medium</button>
          <button type="button" class="btn btn-success btn-rounded btn-sm mb-2 me-2 text-white">Small</button>
        </div>
      </div>
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Кнопки-блоки</p>
          <p class="mb-3">
            Добавьте <code>btn-block</code> чтобы создать кнопку-блок:
          </p>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Скругленные в одну сторону</p>
          <p class="mb-3">
            Добавьте класс <code>btn-pill-left</code> чтобы создать кнопки скругленные слева.
          </p>
          <button type="button" class="btn btn-secondary btn-pill-left mb-2 me-2">Secondary</button>
          <button type="button" class="btn btn-primary btn-pill-left mb-2 me-2">Primary</button>
          <button type="button" class="btn btn-success btn-pill-left mb-2 me-2 text-white">Success</button>
          <button type="button" class="btn btn-info btn-pill-left mb-2 me-2 text-white">Info</button>
          <button type="button" class="btn btn-warning btn-pill-left mb-2 me-2 text-white">Warning</button>
          <button type="button" class="btn btn-danger btn-pill-left mb-2 me-2">Danger</button>
          <button type="button" class="btn btn-pink btn-pill-left mb-2 me-2 text-white">Pink</button>
          <button type="button" class="btn btn-dark btn-pill-left mb-2 me-2">Dark</button>
          <button type="button" class="btn btn-light btn-pill-left mb-2 me-2">Light</button>
          <p class="mb-3">
            Добавьте класс <code>.btn-pill-right</code> чтобы создать кнопки скругленные слева.
          </p>
          <button type="button" class="btn btn-secondary btn-pill-right mb-2 me-2">Secondary</button>
          <button type="button" class="btn btn-primary btn-pill-right mb-2 me-2">Primary</button>
          <button type="button" class="btn btn-success btn-pill-right mb-2 me-2 text-white">Success</button>
          <button type="button" class="btn btn-info btn-pill-right mb-2 me-2 text-white">Info</button>
          <button type="button" class="btn btn-warning btn-pill-right mb-2 me-2 text-white">Warning</button>
          <button type="button" class="btn btn-danger btn-pill-right mb-2 me-2">Danger</button>
          <button type="button" class="btn btn-pink btn-pill-right mb-2 me-2 text-white">Pink</button>
          <button type="button" class="btn btn-dark btn-pill-right mb-2 me-2">Dark</button>
          <button type="button" class="btn btn-light btn-pill-right mb-2 me-2">Light</button>
        </div>
      </div>
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Кнопки со значками</p>
          <p class="mb-3">
            Добавьте в код кнопки <code>&lt;i class="mdi mdi-plus"&gt;&lt;/i&gt;</code> чтобы создать кнопки с значками внутри.
          </p>
          <button type="button" class="btn btn-secondary mb-2 me-2"><i class="mdi mdi-plus"></i> Secondary</button>
          <button type="button" class="btn btn-outline-primary mb-2 me-2"><i class="mdi mdi-file-document"></i> Primary
          </button>
        </div>
      </div>
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Группы кнопок</p>

          <p class="mb-3">
            Используйте элемент <code>&lt;div&gt;</code> с классом <code>.btn-group</code> чтобы создать горизонтальную
            группу
            кнопок:
          </p>
          <div class="btn-group mb-3">
            <button type="button" class="btn btn-primary">Левая</button>
            <button type="button" class="btn btn-primary">Центральная</button>
            <button type="button" class="btn btn-primary">Правая</button>
          </div>
          <p class="mb-3">
            Используйте класс <code>.btn-group-vertical</code> чтобы создать вертикальную группу кнопок:
          </p>
          <div class="btn-group-vertical mb-3">
            <button type="button" class="btn btn-danger text-white">Верхняя</button>
            <button type="button" class="btn btn-warning text-white">Средняя</button>
            <button type="button" class="btn btn-pink text-white">Нижняя</button>
          </div>
          <p class="mb-3">
            Используйте классы <code>.btn-group-lg</code> чтобы сделать большую группу кнопок и
            <code>.btn-group-sm</code>
            чтобы сделать маленькую группу кнопок:
          </p>
          <div class="btn-group btn-group-lg mb-3 me-3">
            <a href="#" class="btn btn-secondary text-white" role="button">Apple</a>
            <a href="#" class="btn btn-dark text-white" role="button">Samsung</a>
            <a href="#" class="btn btn-light" role="button">Sony</a>
          </div>
          <div class="btn-group btn-group-sm">
            <a href="#" class="btn btn-primary text-white" role="button">Apple</a>
            <a href="#" class="btn btn-success text-white" role="button">Samsung</a>
            <a href="#" class="btn btn-info text-white" role="button">Sony</a>
          </div>
          <div class="btn-group" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-info text-white"><i class="mdi mdi-format-align-left"></i></button>
            <button type="button" class="btn btn-info text-white"><i class="mdi mdi-format-align-justify"></i></button>
            <button type="button" class="btn btn-info text-white"><i class="mdi mdi-format-align-right"></i></button>
          </div>
        </div>
      </div>
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Активные / заблокированные кнопки</p>

          <p class="mb-3">
            Класс <code>.active</code> делает кнопку нажатой, а класс <code>.disabled</code> делает кнопку ненажимаемой:
          </p>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Круглые кнопки</p>

          <p class="mb-3">
            Класс <code>btn-circle</code> делает кнопку круглой
          </p>
          <button type="button" class="btn btn-primary btn-circle d-inline-flex align-items-center justify-content-center"><i class="mdi mdi-check-bold"></i></button>
          <button type="button" class="btn btn-primary btn-circle btn-lg d-inline-flex align-items-center justify-content-center"><i class="mdi mdi-check-bold"></i></button>
          <button type="button" class="btn btn-primary btn-circle btn-xl d-inline-flex align-items-center justify-content-center"><i class="mdi mdi-check-bold"></i></button>
          <button type="button" class="btn btn-danger btn-circle btn-xl d-inline-flex align-items-center justify-content-center"><i class="mdi mdi-circle-outline text-white"></i></button>
          <button type="button" class="btn btn-danger btn-circle btn-xl d-inline-flex align-items-center justify-content-center"><i class="mdi mdi-square-outline text-white"></i></button>
          <button type="button" class="btn btn-danger btn-circle btn-xl d-inline-flex align-items-center justify-content-center"><i class="mdi mdi-triangle-outline text-white"></i></button>

        </div>
      </div>
      <div class="card mb-3">
        <div class="card-body">
          <p class="overline-title">Кнопки соцсетей</p>
          <p class="mb-3">
            Класс <code>bg-facebook</code>  и т.д.
          </p>

          <button class="btn bg-facebook text-white" type="button"><i class="mdi mdi-facebook"></i></button>
          <button class="btn bg-twitter text-white" type="button"><i class="mdi mdi-twitter"></i></button>
          <button class="btn bg-googleplus text-white" type="button"><i class="mdi mdi-google"></i></button>
          <button class="btn bg-linkedin text-white" type="button"><i class="mdi mdi-linkedin"></i></button>
          <button class="btn bg-instagram text-white" type="button"><i class="mdi mdi-instagram"></i></button>
          <button class="btn bg-pinterest text-white" type="button"><i class="mdi mdi-pinterest"></i></button>
          <button class="btn bg-youtube text-white" type="button"><i class="mdi mdi-youtube"></i></button>
          <button class="btn bg-odnoklassniki text-white" type="button"><i class="mdi mdi-odnoklassniki"></i></button>
        </div>
      </div>
    </div>
