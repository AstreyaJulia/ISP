...
<aside class="main-sidebar ">
    <ul class="navigation-menu overlayscrollbar os-host-flexbox">
      ...
      <li class="menu-item">
        <a class="menu-link" href="?page=proxylist" data-bs-toggle="tooltip" data-bs-placement="right" title="Каталог ссылок">
      ...
      <li class="menu-item with-sub">
        ...
        <ul class="sub-menu">
          <li class="submenu-item"><a class="submenu-link" data-bs-toggle="tooltip" data-bs-placement="right" href="?page=phonebook" title="Телефонный справочник">
      ...
      <li class="menu-item with-sub">
        ...
        <ul class="sub-menu">
          <li class="submenu-item"><a class="submenu-link" href="?page=faq" data-bs-toggle="tooltip" data-bs-placement="right" title="База знаний">
