  ...
  <div class="ps-3 pe-3">
    ...
    <div class="d-flex justify-content-between">
            <div class="d-flex flex-column p-3">
              ...
              <h5 class="mb-0">Исходящая корреспонденция</h5>
            </div>
            <div class="d-flex me-2 flex-column p-3">
              <div>
                <a class="dropdown-toggle no-carret text-secondary" id="menu14" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
    ...
    <div class="d-flex justify-content-between">
            <div class="d-flex flex-column p-3">
              <h6 class="surtitle">Статистика</h6>
              <h5 class="mb-0">Входящая корреспонденция</h5>
            </div>
            <div class="d-flex me-2 flex-column p-3">
              <div>
                <a class="dropdown-toggle no-carret text-secondary" id="menu14" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
    ...
    <div class="d-flex justify-content-between">
            <div class="d-flex flex-column p-3">
              <h6 class="surtitle">Статистика</h6>
              <h5 class="mb-0">Гражданские дела ап. инстанции (рассмотрено)</h5>
            </div>
            <div class="d-flex me-2 flex-column p-3">
              <div>
                <a class="dropdown-toggle no-carret text-secondary" id="menu14" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
    ...
    <div class="d-flex justify-content-between">
            <div class="d-flex flex-column p-3">
              <h6 class="surtitle">Статистика</h6>
              <h5 class="mb-0">Уголовные дела (рассмотрено)</h5>
            </div>
            <div class="d-flex me-2 flex-column p-3">
              <div>
                <a class="dropdown-toggle no-carret text-secondary" id="menu14" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
    ...
    <div class="d-flex justify-content-between">
            <div class="d-flex flex-column p-3">
              <h6 class="surtitle">Статистика</h6>
              <h5 class="mb-0">Уголовные дела ап. инстанции (рассмотрено)</h5>
            </div>
            <div class="d-flex me-2 flex-column p-3">
              <div>
                <a class="dropdown-toggle no-carret text-secondary" id="menu14" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
    ...
    <div class="d-flex justify-content-between">
            <div class="d-flex flex-column p-3">
              <h6 class="surtitle">Статистика</h6>
              <h5 class="mb-0">Материалы в порядке уг. производства, всего (рассмотрено)</h5>
            </div>
            <div class="d-flex me-2 flex-column p-3">
              <div>
                <a class="dropdown-toggle no-carret text-secondary" id="menu14" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>
