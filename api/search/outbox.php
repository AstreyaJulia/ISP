...
$params = [
  ...
  if($jwt) {
    ...
    try {
      ...
      $queryInbox = $searchClass::sendGET($params, "http://192.168.2.253:8079/api_GAS/search/outbox.php?");
      // получим код ответа
  ...
  // показать сообщение об ошибке, если jwt пуст
    ...
    echo json_encode(array("message" => "Доступ запрещён."), JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
  }
