  ...
  return (
    <>
      ...
      <Transition.Root show={menuVisibility} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={setMenuVisibility}>
          <Transition.Child
            as={Fragment}
          ...
          >
            <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white dark:bg-gray-900 border-r border-gray-200">
              <Transition.Child
                as={Fragment}
      ...
      >
        <div className="flex flex-col flex-grow bg-white dark:bg-gray-900 pt-5 pb-4 overflow-y-auto border-r border-gray-200 dark:border-gray-600">
          <div className={classNames('flex items-center justify-center flex-shrink-0 px-4 h-10 mb-3')}>
          ...
          <nav className="flex-1 flex flex-col overflow-y-auto" aria-label="Меню">
            <PerfectScrollbar className="main-menu-content" options={{ wheelPropagation: false }}>
              <div className={classNames('px-3', sidebar?.toString() === '0' ? 'justify-center' : '')}>
                <MenuItems
                  items={menuData}
                  groupOpen={groupOpen}
                  groupActive={groupActive}
