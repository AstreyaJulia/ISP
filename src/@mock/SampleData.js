...
export const stat = [
  ...
  /* Данные: https://города-россия.рф/sity_id.php?id=394 */
  {
    ...
    data: [
      { name: 'Смоленской области', data: [993018, 982887, 980482, 975188, 967896, 964791, 958630, 953201, 949348, 942363, 934889, 921127] },
    ],
  },
  {
  ...
  },
  {
    ...
    data: [
      { name: 'Рассмотрено уголовных дел по апелляционной инстанции', data: [15, 30, 17, 17, 13, 8, 14, 9, 9, 6, 13, 9, 11] },
    ],
  },
  {
  ...
  },
  {
    ...
    data: [
      { name: 'Рассмотрено гражданских дел по по апелляционной', data: [45, 62, 43, 60, 58, 57, 42, 35, 51, 68, 58, 49] },
    ],
  }
]
