            ...
            <div className='flex flex-col gap-2 w-full'>
                {isLoading === 'true' ? <><LoadingSkeleton classnames='h-8'/>
                    ...
                    <div
                        ...
                        <Typography variant='subtitle2'>{currentUser?.professionName}</Typography>
        ...
        {isLoading === 'true' ? <div className='flex flex-col w-full gap-2'>
            ...
            <dl className='grid grid-cols-1 gap-x-2 gap-y-2 sm:grid-cols-2'>
                <div className='flex items-center gap-3'>
                    ...
                    <dd>
                        <Typography
                            variant='body2'>{fDate(parseISO(currentUser?.dob ?? formatISO(new Date())))} ({getAge(currentUser?.dob ?? formatISO(new Date()))})</Typography>
                    </dd>
                </div>
                <div className='flex items-center gap-3'/>
            </dl>
