    ...
    <Card classname='max-w-3xl mx-auto p-6 mt-6'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <p className='text-base font-medium text-gray-500'>
            ...
            {currentUser?.affiliationJudgeName ?
              <span className='text-gray-900'>: {getInitials(currentUser?.affiliationJudgeName)}</span> : ''}
          </p>
        </div>
      </div>
      ...
      <dl className='grid grid-cols-1 gap-x-2 gap-y-2 sm:grid-cols-2 mb-6'>
        <div className='flex items-center gap-3'>
          ...
          <dd className='text-sm text-gray-900'>{currentUser?.dob}</dd>
        </div>
        <div className='flex items-center gap-3' />
        <div className='flex items-center gap-3'>
          <dt className='text-sm font-medium text-gray-500'>
          ...
          <dd className='text-sm text-gray-900'>{currentUser?.professionName}{' '}
            {currentUser?.affiliationJudgeName ?
              <span className='text-gray-900'>: {getInitials(currentUser?.affiliationJudgeName)}</span> : ''}</dd>
        </div>
        <div className='flex items-center gap-3 '>
          <dt className='text-sm font-medium text-gray-500'>
      ...
      {user?.sudo === 0 ? <Alert alertType='info' title='Пожалуйста, не передавайте данные пользователей третьим лицам без их разрешения.'
