...
const Alert = ({ title, alertType, children, containerClassName }) => {
  ...
  const alertTypes = {
    error: {
      ...
      icon: <svg className="h-5 w-5 fill-red-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="24px"
    ...
    warning: {
      ...
      icon: <svg className="h-5 w-5 fill-yellow-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="24px"
                 viewBox="0 0 24 24" width="24px" fill="#000000">
        <path d="M0 0h24v24H0V0z" fill="none" />
    ...
    success: {
      ...
      icon: <svg className="h-5 w-5 fill-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="24px"
                 viewBox="0 0 24 24" width="24px" fill="#000000">
        <path d="M0 0h24v24H0V0z" fill="none" />
        <path
  ...
  return (
    <div className={classNames("rounded-md p-4", alertTypes[alertType].containerColor, containerClassName ?? '')}>
      <div className="flex">
        ...
        <div className="ml-3">
          {title ? <h3 className={classNames("text-sm font-medium", title ? alertTypes[alertType].titleColor : '')}>{title}</h3> : ''}
