...
const UsersListAdmin = ({ data, isLoading, error }) => {
    ...
    <Card classname='p-4 flex justify-between items-center' key={item?.id}>
      <div className='flex gap-5 items-center'>
        ...
        <div className='flex flex-col items-start justify-center'>
          <p
            className='font-medium text-base text-slate-800 dark:text-slate-200 flex flex-wrap w-48 items-center'>
            <span
        ...
        <div className='flex flex-col items-start justify-center'>
          ...
          {item?.ip ? <p
            className='mt-1 text-sm text-slate-800 dark:text-slate-200 flex items-center'>
            <CopyToClipboard
              text={item?.ip}
            ...
            >
              ...
              >
                {copied === 'false' ? (
                  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className='w-4 h-4 fill-slate-400'>
                    <path
      ...
      <Menu as='div' className='relative'>
        <Menu.Button>
          <div className='flex-shrink-0 px-2'>
            <div
              className='w-8 h-8 bg-white dark:bg-slate-800 inline-flex items-center justify-center text-gray-400 rounded-full bg-transparent hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'>
        ...
        <Menu.Items
          className='absolute right-0 z-50 mt-2 w-40 origin-top-right divide-y divide-gray-100 dark:divide-gray-700 rounded-md bg-white dark:bg-slate-900 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
  ...
  return (
    <DataTableCore
      ...
      error={error}
      columns={columns}
      itemsContainerClassNames='flex flex-col gap-4 bg-slate-100 dark:bg-slate-800 p-4'
