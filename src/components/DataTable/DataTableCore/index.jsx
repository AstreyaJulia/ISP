    ...
    <Card classname={classname || ''}>
      ...
      {isTable === 'true' ? (
        <table className='w-full my-5'>
          ...
          {error !== null ? (<tr>
            <td colSpan={columns.slice(startColumn, endColumn).length}
        ...
        <div className={pseudoTableBodyClassNames || 'px-4 py-5 sm:p-4'}>
          <div className={itemsContainerClassNames || ''}>
            ...
            {isLoading === 'true' ? (
              ...
              <p
                className='flex justify-center items-center text-slate-700 dark:text-slate-300 text-sm py-5 col-span-full'>
