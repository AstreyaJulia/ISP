        ...
        <BasicPage title="Качество" className="main-content max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-3 mt-4 gap-4">
                <div className='flex flex-col gap-4'>
                    <CasesOverPeriodWidget rows={overperiodcases ?? []} isLoading={overperiodisLoading}
                                           error={overperioderror ?? null}/>
                    <NoPublicatedActs rows={nopublacts} error={nopublactserror} isLoading={nopublactsisLoading}/>
                </div>
            </div>
        </BasicPage>
    );
