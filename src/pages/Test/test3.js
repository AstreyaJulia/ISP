...
const Faq = () => {
  ...
  return (
    <main className='flex-1 flex overflow-hidden'>
      ...
      >
        <div
          className='bg-white m-6 min-w-0 flex-1 flex flex-col overflow-y-auto lg:order-last xl:max-w-5xl xl:mx-auto'>
              ...
              <Markdown
                options={{
                  ...
                  overrides: {
                    ...
                    th: {
                      props: {
                        className: 'border border-gray-300 py-1 px-2 font-medium ',
                      },
                    },
                    form: {
                      props: {
                    ...
                    hgroup: {
                      props: {
                        className: 'pl-3 border-l-8 border-cyan-500',
                      },
                    },
                    hr: {
                      props: {
