    ...
    <BasicPage title='Тестовая страница' className='main-content max-w-6xl mx-auto px-4' >
      ...
      <div className='grid grid-cols-2 mt-4 gap-4'>
        <Card classname='p-5'>
          ...
          <h3 className='text-xl font-medium text-gray-700'>Дела</h3>
        </div>
        </Card>
        ...
        <Card classname='p-4'>
          <div className='flex items-center gap-3'>
            ...
            <div className="flex flex-col items-start mr-7 w-72">
              <p
                className="font-medium text-base text-slate-800 dark:text-slate-200 flex flex-wrap justify-start items-center text-left">Иванов Иван Иванович</p>
              <p
                className="text-sm text-indigo-700 dark:text-indigo-300 flex flex-wrap justify-start items-center text-left">Помощник судьи</p>
              ...
              <div className="w-0 flex-1 flex">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round"
                          d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" />
                  </svg>                  <span className="ml-3">Email</span>
                </a>
              </div>
