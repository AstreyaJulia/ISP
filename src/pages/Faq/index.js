    ...
    return (
      ...
      <Disclosure key={key}>
        {({ open }) => (
          <>
            <Disclosure.Button
              className={classNames("mt-2 py-3 pl-2 w-full flex items-center rounded-md shrink-0 w-full hover:bg-slate-200", open ? "bg-indigo-100 text-indigo-800 dark:bg-indigo-700/30 dark:text-indigo-200" : "bg-slate-50 text-slate-800 dark:bg-slate-900 dark:text-slate-200")}>
