...
const Gas = () => {
  const breadcrumbs = [{ name: "База знаний", href: "/faq", current: false }, { name: "Подсистемы ГАС Правосудие", href: "/faq/gas", current: false }, { name: "Категории гражданских и административных дел", href: "/faq/gas/g-category", current: true }];
