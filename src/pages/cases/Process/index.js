...
const Process = ({all}) => {
  ...
  return (
      <BasicPage title="Дела, находящиеся в производстве" className="main-content max-w-6xl mx-auto px-5">
        <PageHeader pages={all === 'true' ? breadcrumbsAll : breadcrumbs}
                    header={all === 'true' ? 'Дела, находящиеся в производстве (общий список)' : 'Дела, находящиеся в производстве (по судье)'}/>
        <Processed
