        ...
        <div className="p-4 h-full flex flex-col">
          ...
          <div className="flex flex-col gap-2 grow">
            ...
            {isGroupLoading === 'false' && errorGroups ? (
              <div className="flex flex-col grow justify-center">
                <div className="w-full h-full border-2 border-red-300 dark:border-red-700 border-dashed rounded-md px-6 pt-5 pb-6 flex flex-col items-center justify-center">
                      ...
                      <Menu.Items className="absolute right-0 z-50 mt-2 w-40 origin-top-right divide-y divide-gray-100 dark:divide-gray-700 rounded-md bg-white dark:bg-slate-900 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div className="px-1 py-1 ">
                          <Menu.Item>
                            {({ active }) => (
                              <a
                                href={`/info/proxy-list/group/${group.id}/edit`}
                                className={`${
