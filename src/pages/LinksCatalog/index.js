      ...
      <ContentLayoutWithSidebar.Body color="white">
        <div className="p-4 h-full">
          <div className="mb-4 h-8">
            {user.sudo === 1
              ? <>
                <Link to='group/new' className='inline-flex items-center justify-center bg-white dark:bg-gray-900 border border-gray-300 rounded-md shadow-sm leading-4 font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:border-gray-600 dark:hover:bg-gray-700 px-4 py-2 text-sm mr-3'>Добавить группу</Link>
                <Link to='link/new' className='inline-flex items-center justify-center bg-white dark:bg-gray-900 border border-gray-300 rounded-md shadow-sm leading-4 font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:border-gray-600 dark:hover:bg-gray-700 px-4 py-2 text-sm'>Добавить ссылку</Link>
              </>
              : null}
          </div>
