...
const UserWelcomeWidget = ({ user }) => (
  <div className="bg-indigo-700 rounded-md w-full flex justify-between relative shadow">
    ...
    <svg
      className="absolute w-2 h-2 top-5 right-5"
      version="1.0"
      fill="#EECC15"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
    ...
    <svg
      className="absolute w-1 h-1 top-4 right-4"
      version="1.0"
      fill="#EECC15"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
    ...
    <svg
      className="absolute w-1 h-1 top-4 left-14"
      version="1.0"
      fill="#EECC15"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
    ...
    <svg
      className="absolute w-2 h-2 top-20 right-1"
      version="1.0"
      fill="#EECC15"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
    ...
    <svg
      className="animate-pulse rotate-12 absolute w-4 h-4 top-14 right-5"
      version="1.0"
      fill="#EECC15"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
    ...
    <svg
      className="absolute w-2 h-2 animate-pulse top-10 right-36"
      version="1.0"
      fill="#EECC15"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
    ...
    <svg
      className="absolute w-1 h-1 top-7 right-24"
      version="1.0"
      fill="#EECC15"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
    ...
    <svg
      className="absolute w-3 h-3 top-2 right-32"
      version="1.0"
      fill="#EECC15"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
