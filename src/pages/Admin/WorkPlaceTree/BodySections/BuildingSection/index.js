            ...
            {selectedTab === 'buildingInfo' ? <>
                    ...
                    <PerfectScrollbar options={{wheelPropagation: false}}>
                        <div className='flex flex-col gap-3 items-start p-3'>
                            ...
                            <Typography variant='caption' classname='mb-2'>Почтовый адрес: г. Сафоново, ул.
                                Красногвардейская, д.41</Typography>
                            <Typography variant='h6' classname='mb-2'>Примечание</Typography>
                            <Typography variant='caption' classname='mb-2'>Основное здание суда. Подсудность - Сафоновский
                                район.</Typography>
                        </div>
                    </PerfectScrollbar></>
