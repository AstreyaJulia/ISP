        ...
        <>
          ...
          <PerfectScrollbar options={{ wheelPropagation: false }}>
            <div className='flex flex-col gap-3 items-start p-3'>
              ...
              <Typography variant='caption' classname='mb-2'>Пользователь рабочего места: Иванов И.И.</Typography>
              <Typography variant='caption' classname='mb-2'>Количество бытовых розеток 220в: 2</Typography>
              <Typography variant='caption' classname='mb-2'>Количество компьютерных розеток 220в: 4</Typography>
              <Typography variant='h6' classname='mb-2'>Примечание</Typography>
              <Typography variant='caption' classname='mb-2'>Первое рабочее место от входа в кабинет, по часовой стрелке</Typography>
            </div>
          </PerfectScrollbar></>
        ...
        : selectedTab === 'workplaceHardware' ?
          ...
          : selectedTab === 'workplaceSoftware' ?
            <>
              ...
              <PerfectScrollbar options={{ wheelPropagation: false }}>
                <div className='p-2'>
                  <Typography variant='label' classname='mb-2'>Kraftway Credo KC-51 инв. №: 013607012</Typography>
                  <TreeView data={softwareTree} handleOpen={(id) => id} count={0} error={error}
                            selectedNode={selectedSoftwareNode} setSelectedNode={(node) => setSelectedSoftwareNode(node)}
                            handleNameClick={(node) => node} />
                </div>
            ...
            : selectedTab === 'workplaceNetwork' ?
              <>
                ...
                <PerfectScrollbar options={{ wheelPropagation: false }}>
                  ...
                  <Typography variant='caption' classname='mb-2'>IP в локальной сети: 192.168.2.111</Typography>
                  <Typography variant='caption' classname='mb-2'>Номер сетевой розетки: 111</Typography>
                  <Typography variant='caption' classname='mb-2'>Сетевое имя компьютера: Computer</Typography>
                  </div>
                </PerfectScrollbar></>
