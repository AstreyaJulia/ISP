...
export const caseTypesSettings = {
  ADM1: {
    color: 'indigo', name: 'Жалобы по делам об административных правонарушениях',
  }, ADM: {
    color: 'blue', name: 'Дела об административных правонарушениях',
  }, G1: {
    color: 'green', name: 'Гражданские дела первой инстанции',
  }, M: {
    color: 'orange', name: 'Материалы в порядке исполнения решений, ОРМ, досудебные материалы',
  }, U1: {
    color: 'red', name: 'Уголовные дела первой инстанции',
  },
};
 ...
 */
export const profCodes = [{ id: 1, profession: 'Председатель', group: 24 }, {
  id: 2, profession: 'Заместитель председателя', group: 24,
}, { id: 3, profession: 'Судья', group: 24 }, { id: 4, profession: 'Начальник отдела', group: 27 }, {
...
}, { id: 12, profession: 'Секретарь суда', group: 27 }, { id: 13, profession: 'Специалист', group: 27 }, {
...
}, { id: 23, profession: 'Рабочий, 3 разряд', group: 27 }, { id: 24, profession: 'Судьи', group: null }, {
 ...
 * @type {[{header: string, accessibleRoles: number[]},{icon: JSX.Element, alias: string, id: string, pagetitle: string, accessibleRoles: number[]},{children: [{icon: string, alias: string, id: string, pagetitle: string, accessibleProfessions: number[]},{icon: string, alias: string, id: string, pagetitle: string, accessibleProfessions: number[]},{icon: string, alias: string, id: string, pagetitle: string, accessibleProfessions: number[]}], icon: string, id: string, pagetitle: string, accessibleProfessions: number[]},{icon: string, alias: string, id: string, pagetitle: string, accessibleRoles: number[]},{badgeColor: string, icon: string, alias: string, id: string, pagetitle: string, badgeText: string, accessibleRoles: number[]},null,null,null,null,null,null,null,null,null]}
...
export const navigation = [{
  header: 'Главное меню', accessibleRoles: [0, 1],
}, {
  id: '1',
  pagetitle: 'Главная',
  ...
  children: [{
    ...
    icon: <svg xmlns='http://www.w3.org/2000/svg' enableBackground='new 0 0 24 24' height='24px' viewBox='0 0 24 24'
      ...
      <g>
        <g>
          <path d='M12,20c1.47,0,2.83-0.45,3.95-1.22L6.22,9.05C5.45,10.17,5,11.53,5,13C5,16.87,8.13,20,12,20z'
                opacity='.3' />
          <path
      ...
      <g>
        <g>
          <path
            ...
            enableBackground='new' opacity='.3' />
          <path
  ...
  header: 'Администрирование', accessibleRoles: [1],
}, {
  id: '12',
  ...
  {
    header: 'Документация', accessibleRoles: [1],
  }, {
    id: '120',
    ...
    children: [
      ...
      },
      {
        id: '14',
        pagetitle: 'Тени',
        icon: <svg xmlns='http://www.w3.org/2000/svg' enableBackground='new 0 0 24 24' height='24px'
